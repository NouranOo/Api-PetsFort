...
class FCMHelper
{
    ...
    */
    ...
    public static function  sendFCMMessage($data, $target)
    {
        ...
        $server_key =
            'AAAA5T7t-EQ:APA91bFNHb2yxdmnodIAB2spU7ZJOtVxCTyUdBC3M_HKDaCgMwOFaEsw2Q4NOYPKIqdbvbQLsGngN_j3TcX_1jA43Vj06ZBYy41SrLEBqIdOD1qoc7ivTKK24m8cNcU-EIk15epPZZgn';
        $fields = array();
